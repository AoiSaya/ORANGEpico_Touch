-----------------------------------------------
-- touch sensor XPT2046 test for W4.00.03
...
fa.serial("init")
fa.serial("write",C_ETX) -- [break]

for i=1,#BASIC_PRG do
	c = string.sub(BASIC_PRG,i,i)
	if c==C_LF then c=C_CR end
	fa.serial("write",c)
	sleep(2)
end
